...
1. almost done Add more players with separate key binding and collisions between players.
...
6*. done Add walls that disappear (similar to task 2, but obstacle reappears randomly on hit).
